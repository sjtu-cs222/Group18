...
class LocalModel(object):
    def __init__(self, model_config, data_collected):
        ...
        self.model.compile(loss={'ctc': lambda y_true, output: output}, optimizer=opt)
    ...
    def train_one_round(self):
        ...
        for k in range(epochs):
            ...
            self.model.fit_generator(batch, steps_per_epoch=batch_num, epochs=1)
...
class FederatedClient(object):
    ...
    def on_init(self, *args):
        ...
        fake_data = (datasource, datasource, [])
        my_class_distr = 1
...
if __name__ == "__main__":
    ...
    FederatedClient("127.0.0.1", 5000, train_data)
